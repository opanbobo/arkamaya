...
/* Template Name: Junior Program Template */
	...
	<div class="class-format-wrapper">
		<div class="container">
			...
			<h1 class="title">Available Class Format</h1>
				...
				<div class="center bottom"><span class="colours"><i>Notes : All ages are welcome. Kids under the age of 7 must be supervised by a parent/adult during class.</i></span></div>
			</div>
		</div>	
	</div>
					...
					<div class="column col-md-6 offset-md-3">
						<div class="block">
							<div class="row">
								...
								<div class="col-2"><div class="txt">Burger Pizza Lasagna</div></div>
								<div class="col-2">
									<div class="img"><img src="<?php bloginfo('template_url');?>/img/ico-coffee.png" alt="" class="img-fluid"></div>
								</div>
								<div class="col-6"><div class="txt">Sugar Cookies <br> Funfetti Mountain Cupcakes Unicorn Cupcakes</div></div>
							</div>
						</div>
					</div>
				</div>
	...
	<div class="gallery-wrapper">
		<div class="gallery-slider">
			...
			<div class="slider gallery-sliders">
				<?php
                    $args = array( 'post_type' => 'gallery_sliders', 'cat' => 12);
