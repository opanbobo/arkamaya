...
/* Template Name: Culinary Team Building Template */
				...
				<?php
                  ...
                  <?php while($query -> have_posts()) : $query -> the_post();?>  
					<div class="col-md-6 col-12">
						<div class="block">
							<div class="row">
								<div class="col-md-3 imgs"><?php the_post_thumbnail('', array('class' => 'img-fluid'))?></div>
								<div class="col-md-9">
					...
					<div class="column col-md-6 offset-md-3">
						<div class="block">
							<div class="row">
								...
								<div class="col-9"><div class="txt">Sunda Cuisine, Bali Cuisine, Betawi Cuisine, Quiche Lorraine, Sate Maranggi and Sate Lilit Bali, Angel Hair Pasta with Chicken Sambal Matah & Caesar Salad</div></div>
							</div>
						</div>
						<div class="block">
							<div class="row">
								...
								<div class="col-9"><div class="txt">Oreo Cake, Carrot Cake, Classic Red Velvet Cake, Mocha Nougat Cake, Ovomaltine Cake, Es Teler Cake, Klepon Cake, Nastar Cake</div></div>
							</div>
						</div>
					</div>
				</div>
	...
	<div class="gallery-wrapper">
		<div class="gallery-slider">
			...
			<div class="slider gallery-sliders">
				<?php
                    $args = array( 'post_type' => 'gallery_sliders', 'cat' => 9);
